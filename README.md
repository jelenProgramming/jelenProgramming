...
**[CS Courses](https://cs-courses.vercel.app)** | 97-topic interactive reference for first-year CS students. Algorithms, data structures, calculus, discrete math and programming. 51 live visualizers, bilingual EN/DE, KaTeX math rendering. React + Vite.
...
**[Consensus Weather](https://weather-app-jelen.vercel.app)** | Averages 13+ national weather models (ECMWF, GFS, ICON and more) into one calculated forecast with a confidence score, over a live animated sky. React.
